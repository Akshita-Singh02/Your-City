...
<%@ page import="com.help.cityhelper.dao.CityDao"%>
<%@ page import="com.help.cityhelper.entities.City"%>
...
.input:placeholder-shown {
  font-size: 0.5em;
            ...
            <div class="col-md-4 offset-md-7">
                  ...
                  <form action="Register" method="post">
                    <div class="mb-3">
                        ...
                        <h4 class="offset-md-4"><b>SIGN UP</b></h4>
    <label for="exampleInputEmail1" class="form-label"><small>Name</small></label>
    ...
    <label for="exampleInputEmail1" class="form-label"><small>Email address</small></label>
    ...
    <label for="exampleInputEmail1" class="form-label"><small>Phone Number</small></label>
    <input type="text" name="user_phone" class="form-control" style="border-radius:4px;border-color: black; " id="phone" aria-describedby="emailHelp" placeholder="Enter phone number" required>
...
<div class="mb-3">
    ...
    <label for="pPic"> select user profile</label>
        <input type="file" id="pPic" name="uPic" required/>
  ...
  <div class="mb-3">
    <label for="exampleInputPassword1" class="form-label"><small>Password<small></label>
